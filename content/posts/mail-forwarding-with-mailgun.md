...
![Domains link in the Mailgun nav bar]({filename}../images/mailgun-nav-domains.png)
...
![Providing a custom domain name]({filename}../images/mailgun-custom-domain-entry.png)
...
![Forcing Mailgun to check DNS records]({filename}../images/mailgun-force-dns-check.png)
...
![Routes link in the Mailgun nav bar]({filename}../images/mailgun-nav-routes.png)
...
![Mailgun route creation form]({filename}../images/mailgun-route-form.png)
...
![Mailgun domain information section]({filename}../images/mailgun-domain-info.png)
...
![Navigating to Gmail settings]({filename}../images/gmail-menu-settings.png)

Select the "Accounts and Import" tab. In the "Send mail as" section, click the "Add another email address you own" link.

![Gmail send mail as section]({filename}../images/gmail-accounts-and-import.png)
...
![Entering information about another email address to Gmail]({filename}../images/gmail-new-address-info.png)
...
![Providing SMTP credentials for your new email address to Gmail]({filename}../images/gmail-new-address-smtp-credentials.png)
...
![Gmail send mail as section with new email address]({filename}../images/gmail-send-mail-as.png)

You can now select your new email address when composing Gmail messages.

![Composing a new Gmail message sent from a custom email address]({filename}../images/gmail-new-message.png)
